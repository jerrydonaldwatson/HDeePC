...
subplot(3,1,1)
plot(1:k,u_sim_dpc(1,1:k), 1:k,u_sim_hdpc(1,1:k), 1:k,u_sim_mpc(1,1:k))
title('BESS current (u_1)')
ylabel('Current (A)')
%legend('DeePC', 'HDeePC', 'Location', 'best')
set(gca,'FontSize',12) 
subplot(3,1,2)
plot(1:k,y_sim_dpc(1,1:k), 1:k,y_sim_hdpc(1,1:k), 1:k,y_sim_mpc(1,1:k))
