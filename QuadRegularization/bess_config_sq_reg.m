%% BESS Simulation (Example 1, config - using a quadratic regularisation term)
% Jeremy Watson, 2025
%
% This code accompanies our paper: "Hybrid Data-Enabled Predictive
% Control: Incorporating model knowledge into the DeePC"
%
% Run this file first to set-up parameters for both bess_hdeepc_sq_reg.m and
% bess_deepc_sq_reg.m
%
