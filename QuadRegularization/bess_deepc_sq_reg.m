%% BESS Simulation (Example 1, DeePC - using a quadratic regularisation term)
% Jeremy Watson, 2025
%
...
for k = 1:lengthSim
    ...
    minimize quad_form(y-r,Qexpanded) + quad_form(u,Rexpanded) + lg * quad_form(g,eye(G)) + ly * norm(sigma_y,1) % Complete cost function
